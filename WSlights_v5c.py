...
simulation_file = 'pegboard_sim.txt'
WM_ll = 1.9
WM_ul = 2.3
Csamp_scale = 10
...
outfile = open('/media/usb/WSlights_%d.txt'%(starttime),'w')
modfile = open('/media/usb/WSlights_%d_summary.txt'%(starttime),'w')
